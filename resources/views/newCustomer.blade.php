...
<html lang="en">
  ...
  <head>
    ...
    <title>Presenter - New customer</title>
  ...
  <body id="wrapper">
    ...
    <header class="masthead bg-primary text-white text-center">
      <div class="container">
        ...
        <hr class="star-light">-->
        <h2 class="font-weight-bold text-uppercase mb-0">New customer entry</h2>
      </div>
    </header>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-8 mx-auto">
            ...
            <form name="newCustomer" id="newCustomer" novalidate="novalidate" action="/newCustomer" method="post">
            {{csrf_field()}}
